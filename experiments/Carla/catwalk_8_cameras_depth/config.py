...
def get_dataset(camera_list=None, frame_list=None, background=False, use_depth=False, subsample_type=None, animation='Catwalk'):
...
class Train:
    ...
    def get_loss_weights(self):
        return {"i_rgb_mse": 1.0, "i_depth_mse": 100, "kl_div": 0.001, "alpha_prior": 0.01, "tvl1": 0.01}
