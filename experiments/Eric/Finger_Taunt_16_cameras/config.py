...
class Train:
    ...
    def get_dataset(self):
        return get_dataset(camera_list=[i for i in range(1, parameters.CAMERAS_NUMBER, 2)],
...
class Progress:
    ...
    def get_dataset(self): return get_dataset(camera_list=[i for i in range(1, parameters.CAMERAS_NUMBER, 2)],
